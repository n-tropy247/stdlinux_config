...
#
# usage:
# usrasync_process_results <worker_name> <callback_function>
#
# callback_function is called with the following parameters:
# usr$1 = job name, e.g. the function passed to async_job
# usr$2 = return code
# usr$3 = resulting stdout from execution
# usr$4 = execution time, floating point e.g. 2.05 seconds
# usr$5 = resulting stderr from execution
#usr$6 = has next result in buffer (0 = buffer empty, 1 = yes)
#
...
#
# usage:
# usrasync_job <worker_name> <my_function> [<function_params>]
#
async_job() {
...
#
# usage:
# usrasync_register_callback <worker_name> <callback_function>
#
...
#
# usage:
# usrasync_unregister_callback <worker_name>
#
...
#
# usage:
# usrasync_flush_jobs <worker_name>
#
async_flush_jobs() {
    setopt localoptions noshwordsplit
...
#
# usage:
# usrasync_start_worker <worker_name> [-u] [-n] [-p <pid>]
#
# opts:
# usr-u unique (only unique job names can run)
# usr-n notify through SIGWINCH signal
# usr-p pid to notify (defaults to current pid)
#
async_start_worker() {
    setopt localoptions noshwordsplit
    ...
    # Re-enable it if it was enabled, for debugginh.
...
#
# usage:
# usrasync_stop_worker <worker_name_1> [<worker_name_2>]
#
async_stop_worker() {
    setopt localoptions noshwordsplit
